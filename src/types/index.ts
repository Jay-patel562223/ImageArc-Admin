...
export interface PriceQueryOptions extends QueryOptions {
  type: string;
  name: string;
}
...
export interface SystemConfigQueryOptions extends QueryOptions {
  type: string;
  name: string;
  parent: number | null;
}
...
export interface PackageTypeQueryOptions extends QueryOptions {
  type: string;
  name: string;
}
...
export interface CountryPaginator extends PaginatorInfo<Country> {}

export interface StatePaginator extends PaginatorInfo<State> {}

export interface PackageTypePaginator extends PaginatorInfo<PackageType> {}

export interface SubscriptionPaginator extends PaginatorInfo<Subscription> {}
...
export interface ContactUsPaginator extends PaginatorInfo<ContactUs> {}

export interface SystemConfigPaginator extends PaginatorInfo<SystemConfig> {}

export interface PrivactPolicyPaginator extends PaginatorInfo<PrivacyPolicy> {}

export interface PagePaginator extends PaginatorInfo<Page> {}

export interface PricePaginator extends PaginatorInfo<Price> {}
