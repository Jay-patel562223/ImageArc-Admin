...
import { pageIcons } from './product-dpi-icons';
import { useTranslation } from 'next-i18next';
import FileInput from '@/components/ui/file-input';
import SelectInput from '@/components/ui/select-input';
import { yupResolver } from '@hookform/resolvers/yup';
import { pageValidationSchema } from './product-dpi-validation-schema';
import {
  useDpiQuery,
  useCreateDpiMutation,
  useUpdateDpiMutation,
} from '@/data/product_dpi';
  ...
  return (
    ...
    <form onSubmit={handleSubmit(onSubmit)} >
      ...
      {errorMessage ? (
        ...
        <label >{`${t('form:input-label-dpi')}*`}</label>
          <Input
