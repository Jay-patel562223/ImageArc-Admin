...
export const systemConfigValidationSchema = yup.object().shape({
  name:yup.string().required('form:error-Name-required').trim(),
  url:yup.string().matches(URL,'Social media url is required').required('Social media url is required ').trim(),
  image: yup
  .mixed()
  .test(
    'check-digital-file',
