...
export const siteSettings = {
  ...
  sidebarLinks: {
    admin: [
      ...
      {
        href: Routes.productPrice.list,
        label: 'sidebar-nav-item-products-price',
        icon: 'TypesIcon',
      },
      // {
      //   href: Routes.product_dpi.list,
      //   label: 'sidebar-nav-item-products-dpi',
      //   icon: 'AttributeIcon',
      // },
      ...
      },
      {
        ...
        label: 'sidebar-nav-item-transaction',
        icon: 'ReviewIcon',
      },
      // {
      ...
      {
        href: Routes.contactUs.list,
        label: 'sidebar-nav-item-contactUs',
        icon: 'MyShopIcon',
      },
      // {
      ...
      // },
      {
        ...
        label: 'sidebar-nav-item-page',
        icon: 'ReviewIcon',
      },
      {
        href: Routes.countries.list,
        label: 'sidebar-nav-item-country',
        icon: 'DiaryIcon',
      },
      {
        href: Routes.states.list,
        label: 'sidebar-nav-item-state',
        icon: 'ShippingsIcon',
      },
      {
        href: Routes.package_type.list,
        label: 'sidebar-nav-item-package-type',
        icon: 'TagIcon',
      },
      {
      ...
      {
        href: Routes.systemConfig.list,
        label: 'sidebar-nav-item-systemConfig',
        icon: 'AttributeIcon',
      },
      // {
